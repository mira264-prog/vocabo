...
<section id="page1" class="page active">
  <div class="card center">
    ...
    <h1>Vocabo</h1>
    <p class="muted">Ресурс, який допоможе вам покращити рівень англійської мови</p>
    <div style="height:10px"></div>
    <button id="startBtn" class="btn btn-yellow" type="button">Розпочати</button>
  </div>
</section>
...
<section id="page2" class="page">
  <div class="card center">
    ...
    <div class="level-buttons">
	  ...
	  <button class="btn btn-yellow levelBtn" data-level="B2">B2</button>
    </div>
  </div>
</section>
...
<section id="page3" class="page">
  <div class="card center">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:14px;margin-top:20px">
      ...
      <button class="btn btn-yellow" data-target="page7">Listening 🔊</button>
      <button class="btn btn-yellow" data-target="page8">Writing 🔊</button>
    </div>
  </div>
</section>
...
<section id="page4" class="page">
  <div class="card">
    <h2>Reading. Рівень A2</h2>
    <p><i>Last week, a new student came to our class. His name is Daniel. He is from Spain. He likes football and drawing. During the break, we talked and played a game together. He is very friendly. I think we will be good friends.
</i></p>
    <form id="readingForm">
      <p>1) Where is Daniel from?<br>
        <label><input type="radio" name="reading_q1" value="Spain"> Spain</label><br>
        <label><input type="radio" name="reading_q1" value="Italy"> Italy</label>
      </p>
      <p>2) What does Daniel like to do?<br>
        <label><input type="radio" name="reading_q2" value="Playing football and drawing"> Playing football and drawing</label><br>
        <label><input type="radio" name="reading_q2" value="Dancing"> Dancing</label>
      </p>
      <p>3) Why does the writer think they will be good friends?
<br>
        <label><input type="radio" name="reading_q3" value="friendly"> Daniel is very friendly</label><br>
        <label><input type="radio" name="reading_q3" value="tall"> Daniel is tall</label>
      </p> 
    </form>
    <div style="display:flex;gap:10px;flex-wrap:wrap;margin-top:12px;justify-content:center">
      <button class="btn btn-blue" id="checkReadingBtn">Перевірити</button>
      <button class="btn btn-yellow" id="readingAnswerBtn">Правильна відповідь</button>
      <button class="btn btn-blue navBtn" data-target="page3">Назад</button>
      <button class="btn btn-yellow navBtn" data-target="page9">Результати</button>
    </div>
...
<section id="page6" class="page">
  <div class="card">
    <h2>Writing. Рівень A2</h2>
    <div style="display:flex;gap:14px;align-items:center;flex-wrap:wrap">
      <!-- картинка відповідно до опису -->
      ...
      <div style="flex:1;min-width:200px">
        <p class="muted">Опиши картинку англійською (посимвольно порівняємо з еталоном).</p>
        <input id="speakTextInput" type="text" placeholder="">
        <div style="margin-top:12px;display:flex;gap:10px;flex-wrap:wrap">
          <button class="btn btn-blue" id="checkSpeakingBtn">Перевірити</button>
          <button class="btn btn-yellow" id="speakingAnswerBtn">Правильна відповідь</button>
          <button class="btn btn-blue navBtn" data-target="page3">Назад</button>
          <button class="btn btn-yellow navBtn" data-target="page9">Результати</button>
        </div>
...
<section id="page7" class="page">
  <div class="card">
    <h2>Listening. Рівень A2</h2>
    <p class="muted">Натисни <strong>Прослухати</strong> (🔊) — діалог відтвориться голосом браузера.</p>
    <div style="display:flex;gap:10px;justify-content:center;margin-bottom:12px">
      <button class="btn btn-yellow" id="playDialogueBtn">Прослухати 🔊</button>
      <button class="btn btn-blue" id="stopDialogueBtn">Зупинити</button>
    </div>

    <form id="listeningForm">
      <p>1) Where is Emma?<br>
        <label><input type="radio" name="l1" value="In a clothes"> In a clothes</label><br>
        <label><input type="radio" name="l1" value="In a restaurant"> In a restaurant</label>
      </p>
	    <label><input type="radio" name="l1" value="At the supermarket"> At the supermarket </label>
      </p>
      <p>2) What does she want to buy?<br>
        <label><input type="radio" name="l2" value=" A jacket"> A jacket</label><br>
        <label><input type="radio" name="l2" value="A hat"> A hat</label>
      </p>
	    <label><input type="radio" name="l2" value="A hat"> A hat</label>
      </p>
      <p>3) How much does the jacket cost?<br>
        <label><input type="radio" name="l3" value="£30"> £30</label><br>
        <label><input type="radio" name="l3" value="£25"> £25</label>
      </p>
	  <label><input type="radio" name="l3" value="£19"> £19</label>
      </p>
    </form>

    <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center">
      <button class="btn btn-blue" id="checkListeningBtn">Перевірити</button>
      <button class="btn btn-yellow" id="listeningAnswerBtn">Правильна відповідь</button>
      <button class="btn btn-blue navBtn" data-target="page3">Назад</button>
      <button class="btn btn-yellow navBtn" data-target="page9">Результати</button>
    </div>
...
<section id="page8" class="page">
  <div class="card">
    <h2>Speaking / Pronunciation. Рівень A2</h2>
    <p class="muted">Прослухай фразу (🔊), натисни <strong>Записати</strong>, наговори зразок, потім — <strong>Перевірити</strong>.</p>
    <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;margin-bottom:12px">
      <button class="btn btn-yellow" id="playPronBtn">Прослухати 🔊</button>
      <button class="btn btn-blue" id="recBtn">Записати</button>
      <button class="btn btn-blue" id="checkPronBtn">Перевірити</button>
      <button class="btn btn-yellow" id="pronAnswerBtn">Правильна відповідь</button>
    </div>

    <div><b>Розпізнаний текст:</b></div>
...
<section id="page9" class="page">
  <div class="card">
    <h2>Всі результати</h2>
    <div id="allResults" class="muted">Немає результатів поки що.</div>
    <div style="margin-top:12px;display:flex;gap:10px">
      <button class="btn btn-yellow navBtn" data-target="page2">На головну</button>
      <button class="btn btn-blue" id="clearResultsBtn">Очистити результати</button>
    </div>
  </div>
</section>

<footer>
  <button class="btn btn-blue navBtn" data-target="page3">Вибір типу завдання</button>
  <button class="btn btn-yellow navBtn" data-target="page9">Всі результати</button>
</footer>
...
function checkReading(){
  try{
    ...
    document.getElementById('readingResult').textContent = `Результат: ${percent}% (${score}/3)`;
  } catch(e){ console.error(e); alert('Помилка при перевірці Reading'); }
}

/* ========== SPEAKING (text, посимвольно) ========== */
function checkSpeaking(){
  ...
  let matches = 0;
  for(let i=0;i<Math.min(a.length,b.length);i++) if(a[i]===b[i]) matches++;
  document.getElementById('speakingResult').textContent = `Посимвольно: ${percent}% (${matches} збігів з ${Math.max(a.length,b.length)} символів)`;
}
...
function playDialogue(){
  const text = `Oksana: Hi, Mary! How are you? Mary: Hi, Oksana! I'm great, especially since I got a kitty! Oksana: Really? Congratulations! What's her name? Mary: Her name is Milka. She's so cute — gray with white paws and green eyes. Oksana: How lovely! How old is she? Mary: She's five months old. She's very playful, especially loves to chase a ball of yarn.`;
  speakText(text);
}
...
function checkListening(){
  try{
    ...
    document.getElementById('listeningResult').textContent = `Результат: ${percent}% (${score}/3)`;
  } catch(e){ console.error(e); alert('Помилка при перевірці Listening'); }
}
...
function initRecognition(){
  ...
  recognition.onerror = (ev)=>{ console.error('rec error', ev); alert('Помилка розпізнавання: ' + (ev.error||'')); isRecording = false; updateRecBtn(); };
  recognition.onend = ()=>{ isRecording = false; updateRecBtn(); };
}
function toggleRecording(){
  initRecognition();
  if(!recognition){ alert('Розпізнавання голосу не підтримується в цьому браузері. Спробуйте Chrome/Edge.'); return; }
  if(isRecording){ recognition.stop(); isRecording = false; }
  else { lastTranscript=''; document.getElementById('recognizedText').textContent = '... запис ...'; recognition.start(); isRecording = true; }
  updateRecBtn();
}
function updateRecBtn(){ const b = document.getElementById('recBtn'); if(!b) return; b.textContent = isRecording ? 'Зупинити' : 'Записати'; }
function checkPronunciation(){
  if(!lastTranscript){ alert('Немає записаного тексту. Натисніть "Записати" і промовте фразу.'); return; }
  const percent = compareByChar(pronSample, lastTranscript);
  localStorage.setItem('Writing', percent);
  document.getElementById('pronResult').textContent = `Вимова: ${percent}% (впізнано: "${lastTranscript}")`;
}
...
function renderAllResults(){
  ...
  if(!r && !s && !l && !w){ el.innerHTML = 'Немає результатів поки що.'; return; }
  el.innerHTML = `
    Reading: ${r !== null ? r + '%' : '-'}<br>
...
function clearAllResults(){ localStorage.removeItem('Reading'); localStorage.removeItem('Speaking'); localStorage.removeItem('Listening'); localStorage.removeItem('Writing'); renderAllResults(); alert('Результати очищено'); }
...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  if(rans) rans.addEventListener('click', ()=> alert('Правильні: Luna, Gray, On the sofa'));
  ...
  if(sans) sans.addEventListener('click', ()=> alert('Зразок: A black cat is sitting in a box'));
  ...
  if(lans) lans.addEventListener('click', ()=> alert('Правильні: 1) Milka  2) C  3) B'));
  ...
  if(pans) pans.addEventListener('click', ()=> alert('Зразок: I have a little kitten.'));
